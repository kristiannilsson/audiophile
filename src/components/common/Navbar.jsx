...
export default function Navbar() {
  ...
  return (
    <>
      <Nav>
        <MenuIconContainer onClick={toggleMenu} tabIndex="0">
          <MenuIcon
            src={
              menuOpen
                ? "/assets/shared/tablet/icon-close.svg"
                : "/assets/shared/tablet/icon-hamburger.svg"
            }
            alt="menu"
          />
        </MenuIconContainer>
        <Logo width="143" height="25" xmlns="http://www.w3.org/2000/svg">
          <path
        ...
        <Cart width="23" height="20" xmlns="http://www.w3.org/2000/svg">
          <path
